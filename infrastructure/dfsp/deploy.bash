...
kubectl patch serviceaccount default \
  ...
  # Now scale out to ${REPLICAS} replicas (all with updated probes + hostAliases)
  kubectl scale deployment dfsp-sim-fsp${i}-scheme-adapter -n dfsps --replicas=${REPLICAS}

  ## USE below if you need to restart the services
